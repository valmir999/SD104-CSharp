...
namespace HW1
{
     class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Get input
            Console.WriteLine("This program asks for two integers, then...");
            Console.WriteLine("It display their sum, product, difference and quotient.");
...
EnterSecondNumInLoop:
                ...
                Console.Write("1 - The sum of " + firstNum + " + " + secondNum + " equals to " + resultNum);
                Console.WriteLine("");
                ...
                resultNum = firstNum * secondNum;
                Console.Write("2 - The product of " + firstNum + " + " + secondNum + " equals to " + resultNum);
                Console.WriteLine("");
                ...
                resultNum = firstNum - secondNum;
                Console.Write("3 - The difference of " + firstNum + " + " + secondNum + " equals to " + resultNum);
                Console.WriteLine("");
                ...
                resultNum = firstNum / secondNum;
                Console.Write("4 - The quotien of " + firstNum + " + " + secondNum + " equals to {0:F}", resultNum);
                Console.WriteLine("");
