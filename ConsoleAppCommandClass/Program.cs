    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    case 1: monitor.SetBackgroundColor(GetInput("Color? "));
                            break;
                    case 2: monitor.SetForegroundColor(GetInput("Color? "));
                            break;
                    case 3: int lineNum = GetNumber("Enter Line Number ", windowSize - 1);
                            string text = GetInput("? ");
                            monitor.SetScreenText(lineNum, text);
                            break;
                    case 4: monitor.ClearScreen();
                            break;
                    case 5: monitor.SaveScreen(GetInput("File: "));
                            break;
                    case 6: monitor.ReloadScreen(GetInput("File: "));
                            break;
                    case 7: monitor.Display();
                            break;
                    default:
                        //   monitor.ClearScreen();                        
                        break;
                ...
                {
                    int userNumber; string strNumber;
                    do { strNumber = GetInput(prompt);
