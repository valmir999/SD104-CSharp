...
using WebApplicationMusicStore6.Data;
using WebApplicationMusicStore6.Models;
...
namespace WebApplicationMusicStore6.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Artist,Album,ReleaseDate,Genre,ImagePath,Price,SingerEmail")] Song song, IFormFile file)
        {
